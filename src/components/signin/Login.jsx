              ...
              <ul>
                ...
                <li>
                  <ul className='sns-login'>
                    <li><a href="#!"><img src="./img/kakao_logo.png" alt="" /></a></li>
                    <li><a href="#!"><img src="./img/naver_logo.png" alt="" /></a></li>
                    <li><a href="#!"><img src="./img/google_logo.png" alt="" /></a></li>
                  </ul>
                </li>
              </ul>
            </form>
